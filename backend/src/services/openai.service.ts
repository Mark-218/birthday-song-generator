...
- Make sure the mood feels "${mood}" and tone is "${voice}".
...
`;
  ...
  const response = await client.chat.completions.create({
    model: 'gpt-4o-mini', // can switch to 'gpt-4' for higher quality
    messages: [
      { role: 'system', content: 'You are a creative lyricist for birthday songs.' },
